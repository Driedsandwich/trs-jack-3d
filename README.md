...
一切依存しない**からです。採用値 0.05 はそのしきい値の 1/3 です。
接点位置・パッド幅・追従量を総当たりで 2,187 通り振っても、
しきい値未満の 729 通りでは Tip 橋絡は 1 度も出ませんでした
...
- 4極 (TRRS) の**導体境界は 2 社の図面記載寸法からの演算 (FACT)** ですが、
  **4極ジャックの内部接点位置は一次図面が無く全面的に仮定**です。
  ...
  0.721 mm から動きませんでした（[docs/SENSITIVITY.md](docs/SENSITIVITY.md) §4）。
