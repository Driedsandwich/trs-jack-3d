...
| コマンド | 内容 |
|---|---|
| `npm run test` | 単体テスト (Vitest) 185 件 |
...
**さらに同日、Lumberg 自身の 4極ジャック 1503 28（JEITA RC-5325A 準拠）を読むと、逆を指しました。**
Tip ばねの**端子**は 11.30 mm にあり、それを接点位置として計算すると区間は出ます（13.29〜13.50 mm）。

| 根拠 | Tip 接点 | 区間 |
|---|---:|---|
| PS000001（**接点**の寸法記入・商社ブランド） | 12.75 | **なし** |
| Lumberg 1503 28（**端子**位置・メーカー公式） | 11.30 | 13.29〜13.50 |

**実在資料 2 件が割れています。**証拠の種類が違い（一方は接点そのもの、他方は端子）、
どちらが正しいかは資料からは決まりません。
**現象の成否が Tip 接点の軸位置 1 点にかかっている**というのが、いま言えることです。
