...
| うちパッド幅 0.3 mm 以上（製造しうる） | **879** |
| うち**既定値から 1 つも動かさないもの** | **2** |

| variant | 成立 | 製造しうる | 無改造 | 無改造のときの深さ |
|---|---:|---:|---:|---|
...
**とくに 4極 CTIA × 4極ジャックは、ごく普通の組み合わせです。**
マイク付きイヤホンをスマホのジャックへ半挿しにする、それだけです。
3極イヤホンを 4極ジャックへ挿す場合も同様に成立します。
